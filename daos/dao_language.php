 ...
 * @license 
 */
class Dao_language extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('parent_id', 'cn_name', 'en_name', 'level', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'parent_id', 'cn_name', 'en_name', 'level', 'updated_at', 'is_deleted');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'parent_id', 'cn_name', 'en_name', 'level', 'updated_at', 'is_deleted', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_unique_fields = array('id', 'parent_id', 'cn_name');
    /**
     * _index_fields 
     * 
     * @var string
     * @access protected
     */
    protected $_index_fields = array('uidx_parent_id_cn_name' => array(1 => 'parent_id', 2 => 'cn_name', ),'idx_level' => array(1 => 'level', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('parent_id'=>'t','cn_name'=>'t','level'=>'t');
