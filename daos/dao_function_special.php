 ...
 * @license 
 */
class Dao_function_special extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('parent_id', 'industry_id', 'name', 'alias', 'relations', 'uid', 'status', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'parent_id', 'industry_id', 'name', 'alias', 'relations', 'uid', 'status', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'parent_id', 'industry_id', 'name', 'alias', 'relations', 'uid', 'status', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('idx_industry_id' => array(1 => 'industry_id', ),'idx_parent_id' => array(1 => 'parent_id', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('industry_id'=>'t','parent_id'=>'t');
