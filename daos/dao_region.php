 ...
 * @license 
 */
class Dao_region extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('id', 'name', 'code', 'zip', 'area_code', 'abbr', 'parent_id', 'latitude', 'longitude', 'level', 'displayorder', 'user_id', 'user_name', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'name', 'code', 'zip', 'area_code', 'abbr', 'parent_id', 'latitude', 'longitude', 'is_deleted', 'level', 'displayorder', 'user_id', 'user_name', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'name', 'code', 'zip', 'area_code', 'abbr', 'parent_id', 'latitude', 'longitude', 'is_deleted', 'level', 'displayorder', 'user_id', 'user_name', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('idx_parent_id' => array(1 => 'parent_id', ),'idx_level' => array(1 => 'level', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('parent_id'=>'t','level'=>'t');
