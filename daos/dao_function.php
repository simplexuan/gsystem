 ...
 * @license
 */
class Dao_function extends Gsystem_dao {
    /**
     * _table
     *
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('function_id', 'name', 'parent_id', 'depth', 'alias_name', 'remark');
    /**
     * _update_fields
     *
     * @var array
     * @access protected
     */
    protected $_update_fields = array('function_id', 'name', 'parent_id', 'depth', 'alias_name', 'remark', 'is_deleted', 'updated_at');
    /**
     * _select_fields
     *
     * @var array
     * @access protected
     */
    protected $_select_fields = array('function_id', 'name', 'parent_id', 'depth', 'alias_name', 'remark', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key
     *
     * @var mixed
     * @access protected
     */
    protected $_primary_key = 'function_id';
    /**
     * _unique_fields
     *
     * @var array
     * @access protected
     */
    protected $_unique_fields = array('function_id');
    /**
     * _index_fields
     *
     * @var string
     * @access protected
     */
    protected $_index_fields = array('idx_name_is_deleted' => array(1 => 'name', 2 => 'is_deleted'),'idx_parent_id_is_deleted' => array(1 => 'parent_id', 2 => 'is_deleted'),'idx_depth_is_deleted' => array(1 => 'depth', 2 => 'is_deleted'),'idx_is_deleted' => array(1 => 'is_deleted'));
    /**
     * _dao
     *
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('name'=>'t', 'function_id'=>'t', 'parent_id'=>'t', 'depth'=>'t', 'alias_name'=>'t', 'is_deleted'=>'t');
