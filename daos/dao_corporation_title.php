 ...
 * @license
 */
class Dao_corporation_title extends Gsystem_dao {
    /**
     * _table
     *
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('type_id', 'corporation_id', 'sort', 'title', 'description', 'minsalary', 'maxsalary', 'minyear', 'maxyear', 'inner', 'updated_at');
    /**
     * _update_fields
     *
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'type_id', 'corporation_id', 'sort', 'title', 'description', 'minsalary', 'maxsalary', 'minyear', 'maxyear', 'inner', 'is_deleted', 'updated_at');
    /**
     * _select_fields
     *
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'type_id', 'corporation_id', 'sort', 'title', 'description', 'minsalary', 'maxsalary', 'minyear', 'maxyear', '`inner`', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key
     *
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('idx_comporation_id_type_id' => array(1 => 'corporation_id', 2 => 'type_id', ),);
    /**
     * _dao
     *
     * @var string
