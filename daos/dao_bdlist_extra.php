 ...
 * @license 
 */
class Dao_bdlist_extra extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('corporation_id', 'sort', 'maturity_id', 'importance_id', 'recruitment_plan', 'recruitment_budget', 'feature', 'capital', 'revenue', 'profit', 'marketvalue', 'toponline', 'month', 'welfare', 'currency', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'corporation_id', 'sort', 'maturity_id', 'importance_id', 'recruitment_plan', 'recruitment_budget', 'feature', 'capital', 'revenue', 'profit', 'marketvalue', 'toponline', 'month', 'welfare', 'currency', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'corporation_id', 'sort', 'maturity_id', 'importance_id', 'recruitment_plan', 'recruitment_budget', 'feature', 'capital', 'revenue', 'profit', 'marketvalue', 'toponline', 'month', 'welfare', 'currency', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('idx_corporation_id' => array(1 => 'corporation_id', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('corporation_id'=>'t');
