 ...
 * @license 
 */
class Dao_degree extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('name', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'name', 'updated_at', 'is_deleted');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'name', 'updated_at', 'is_deleted', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('uidx_name' => array(1 => 'name', ),);
    /**
     * _dao 
     * 
     * @var string
