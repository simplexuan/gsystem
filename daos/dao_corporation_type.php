 ...
 * @license 
 */
class Dao_corporation_type extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_update_fields = array('id', 'name', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'name', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
