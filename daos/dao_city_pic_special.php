 ...
 * @license
 */
class Dao_city_pic_special extends Gsystem_dao {
    /**
     * _table
     *
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('pic', 'start_time', 'end_time', 'updated_at');
    /**
     * _update_fields
     *
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'pic', 'start_time', 'end_time', 'updated_at');
    /**
     * _select_fields
     *
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'pic', 'start_time', 'end_time', 'created_at', 'updated_at');
    /**
     * _primary_key
     *
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('start_end_time_index' => array(1 => 'start_time', 2 => 'end_time', ),);
    /**
     * _dao
     *
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('start_time'=>'t','end_time'=>'t','id'=>'t');
