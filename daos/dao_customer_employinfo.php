 ...
 * @license 
 */
class Dao_customer_employinfo extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('corporation_id', 'sort', 'culture', 'preference', 'attention', 'reimburse', 'reimbursement', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'corporation_id', 'sort', 'culture', 'preference', 'attention', 'reimburse', 'reimbursement', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'corporation_id', 'sort', 'culture', 'preference', 'attention', 'reimburse', 'reimbursement', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
