 ...
 * @license 
 */
class Dao_bdlist_link extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('corporation_id', 'sort', 'link_time', 'uid', 'username', 'remark', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'corporation_id', 'sort', 'link_time', 'uid', 'username', 'remark', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'corporation_id', 'sort', 'link_time', 'uid', 'username', 'remark', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
