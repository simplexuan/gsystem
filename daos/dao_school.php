 ...
 * @license 
 */
class Dao_school extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('mid', 'type', 'parent_id', 'name_cn', 'name_en', 'alias', 'url', 'introduction', 'baseinfo', 'extendinfo', 'logo', 'status', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'mid', 'type', 'parent_id', 'name_cn', 'name_en', 'alias', 'url', 'introduction', 'baseinfo', 'extendinfo', 'logo', 'status', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'mid', 'type', 'parent_id', 'name_cn', 'name_en', 'alias', 'url', 'introduction', 'baseinfo', 'extendinfo', 'logo', 'created_at', 'status', 'is_deleted', 'updated_at', 'edudirectly');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_unique_fields = array('id', 'parent_id', 'name_cn');
    /**
     * _index_fields 
     * 
     * @var string
     * @access protected
     */
    protected $_index_fields = array('uidx_parent_id_name_cn' => array(1 => 'parent_id', 2 => 'name_cn', ),'idx_name_cn' => array(1 => 'name_cn', ),'idx_status' => array(1 => 'status', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('parent_id'=>'t','name_cn'=>'t','status'=>'t');
