 ...
 * @license 
 */
class Dao_corporation_baike extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('corporation_id', 'sort', 'mid', 'name', 'alias', 'baike_url', 'introduction', 'baseinfo', 'extendinfo', 'status', 'createtime', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'corporation_id', 'sort', 'mid', 'name', 'alias', 'baike_url', 'introduction', 'baseinfo', 'extendinfo', 'status', 'createtime', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'corporation_id', 'sort', 'mid', 'name', 'alias', 'baike_url', 'introduction', 'baseinfo', 'extendinfo', 'status', 'createtime', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('idx_corporation_id' => array(1 => 'corporation_id', ),'idx_mid' => array(1 => 'mid', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('corporation_id'=>'t','mid'=>'t');
