 ...
 * @license 
 */
class Dao_gender extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('name', 'short', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'name', 'short', 'updated_at', 'is_deleted');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'name', 'short', 'updated_at', 'is_deleted', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_unique_fields = array('id', 'name', 'short');
    /**
     * _index_fields 
     * 
     * @var string
     * @access protected
     */
    protected $_index_fields = array('uidx_name' => array(1 => 'name', ),'uidx_short' => array(1 => 'short', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('name'=>'t','short'=>'t');
