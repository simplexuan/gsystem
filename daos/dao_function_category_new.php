 ...
 * @license 
 */
class Dao_function_category_new extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('parent_id', 'name', 'alias_name');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'parent_id', 'name', 'alias_name');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'parent_id', 'name', 'alias_name');
    /**
     * _primary_key 
     * 
     * @var mixed
