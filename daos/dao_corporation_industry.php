 ...
 * @license 
 */
class Dao_corporation_industry extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('type_id', 'corporation_id', 'sort', 'industry_id', 'industry_name');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'type_id', 'corporation_id', 'sort', 'industry_id', 'industry_name', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'type_id', 'corporation_id', 'sort', 'industry_id', 'industry_name', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
