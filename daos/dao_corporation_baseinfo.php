 ...
 * @license 
 */
class Dao_corporation_baseinfo extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('type_id', 'corporation_id', 'sort', 'people', 'profile', 'model', 'founding', 'employee', 'branch', 'phone', 'email', 'logo', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'type_id', 'corporation_id', 'sort', 'people', 'profile', 'model', 'founding', 'employee', 'branch', 'phone', 'email', 'logo', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'type_id', 'corporation_id', 'sort', 'people', 'profile', 'model', 'founding', 'employee', 'branch', 'phone', 'email', 'logo', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_unique_fields = array('id', 'corporation_id', 'type_id');
    /**
     * _index_fields 
     * 
     * @var string
     * @access protected
     */
    protected $_index_fields = array('uidx_corporation_id_type_id' => array(1 => 'corporation_id', 2 => 'type_id', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('corporation_id'=>'t','type_id'=>'t');
