 ...
 * @license 
 */
class Dao_customer extends Gsystem_dao {
    /**
     * _table 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_insert_fields = array('parent_id', 'name', 'website', 'city_id', 'city_name', 'nature_id', 'nature_name', 'size_id', 'size_name', 'uid', 'status', 'updated_at');
    /**
     * _update_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_update_fields = array('id', 'parent_id', 'name', 'website', 'city_id', 'city_name', 'nature_id', 'nature_name', 'size_id', 'size_name', 'uid', 'status', 'is_deleted', 'updated_at');
    /**
     * _select_fields 
     * 
     * @var array
     * @access protected
     */
    protected $_select_fields = array('id', 'parent_id', 'name', 'website', 'city_id', 'city_name', 'nature_id', 'nature_name', 'size_id', 'size_name', 'uid', 'status', 'is_deleted', 'updated_at', 'created_at');
    /**
     * _primary_key 
     * 
     * @var mixed
     ...
     * @access protected
     */
    protected $_index_fields = array('uidx_name' => array(1 => 'name', ),'idx_parent_id' => array(1 => 'parent_id', ),'idx_id_status' => array(1 => 'id', 2 => 'status', ),'idx_status_uid_updated_at' => array(1 => 'status', 2 => 'uid', 3 => 'updated_at', ),'idx_uid_updated_at' => array(1 => 'uid', 2 => 'updated_at', ),'idx_status_updated_at' => array(1 => 'status', 2 => 'updated_at', ),);
    /**
     * _dao 
     * 
     * @var string
    ...
    function search($param = array()) {
        ...
        $equal_search_items = array('name'=>'t','parent_id'=>'t','id'=>'t','status'=>'t','uid'=>'t','updated_at'=>'t');
