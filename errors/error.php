...
?>
<style type="text/css">
#pw_error { background: #ddd; font-size: 1em; font-family:sans-serif; text-align: left; color: #111; }
#pw_error h1,
#pw_error h2 { margin: 0; padding: 1em; font-size: 1em; font-weight: normal; background: #911; color: #fff; }
	#pw_error h1 a,
	#pw_error h2 a { color: #fff; }
#pw_error h2 { background: #222; }
#pw_error h3 { margin: 0; padding: 0.4em 0 0; font-size: 1em; font-weight: normal; }
#pw_error p { margin: 0; padding: 0.2em 0; }
#pw_error a { color: #1b323b; }
#pw_error pre { overflow: auto; white-space: pre-wrap; }
#pw_error table { width: 100%; display: block; margin: 0 0 0.4em; padding: 0; border-collapse: collapse; background: #fff; }
	#pw_error table td { border: solid 1px #ddd; text-align: left; vertical-align: top; padding: 0.4em; }
#pw_error div.content { padding: 0.4em 1em 1em; overflow: hidden; }
#pw_error pre.source { margin: 0 0 1em; padding: 0.4em; background: #fff; border: dotted 1px #b7c680; line-height: 1.2em; }
	#pw_error pre.source span.line { display: block; }
	#pw_error pre.source span.highlight { background: #f0eb96; }
		#pw_error pre.source span.line span.number { color: #666; }
#pw_error ol.trace { display: block; margin: 0 0 0 2em; padding: 0; list-style: decimal; }
	#pw_error ol.trace li { margin: 0; padding: 0; }
...
<div id="pw_error">
	...
	<div id="<?php echo $error_id ?>" class="content">
		...
		<?php echo Debug::debugSource($file, $line) ?>
		<ol class="trace">
