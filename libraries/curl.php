...
**/
require_once dirname(__FILE__). '/curl_response.php';
class Curl {
    ...
    function __construct($cookie_file='') {
        ...
        $this->user_agent = isset($_SERVER['HTTP_USER_AGENT']) ? $_SERVER['HTTP_USER_AGENT'] : 'Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.172 Safari/537.22';
    }
